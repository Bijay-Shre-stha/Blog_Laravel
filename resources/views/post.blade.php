        ...
        <article
            ...
            <div class="col-span-8">
                <div class="hidden lg:flex justify-between mb-6">
                    <a
                        href="/index.html"
                        class="transition-colors duration-300 relative inline-flex items-center text-lg hover:text-blue-400">
                        <svg
                            width="22"
                            height="22"
                            viewBox="0 0 22 22"
                    ...
                    <div class="space-x-2">
                        ...
                        <a
                            href="#"
                            class="px-3 py-1 border border-red-300 rounded-full text-red-300 text-xs uppercase font-semibold hover:bg-red-300 hover:text-white"
                            style="font-size: 10px"
                            >Updates</a
                        >
                    </div>
